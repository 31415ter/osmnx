...
if __name__ == '__main__':
    ...
    # G = snx.download_graph(cities, custom_filter=cf)
    ...
    # get_required_edges(cities = ["Spaanse Polder"], highway_types = ["unclassified"])
    ...
    # snx.save_graph(G, name + ("_Spaanse_Polder" if cf is None else "_custom_network"))
